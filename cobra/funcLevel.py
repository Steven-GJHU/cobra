...
def detectContractName(file):
    contractNodes = []
    contractNames = []
    findType(file, 'ContractStatement', contractNodes)
    for contract in contractNodes:
        contractNames +=contract['name']

    return contractNames

def detectStructName(file):
    structNodes = []
    structNames = []
    findType(file, 'StructDeclaration', structNodes)
    for struct in structNodes:
        structNames.append(struct['name'])
